<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="1_Delete.aspx.cs" Inherits="WebApplication1.Delete" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Label ID="lblInsert" runat="server" Font-Bold="True" Font-Size="Larger"  Text="Delete data"></asp:Label>
            <br />
            <br />
            <asp:Label ID="Label1" runat="server" Font-Bold="True" ForeColor="blue" Text="Student deleted" Visible="False"></asp:Label>
            <br />
            <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <asp:TextBox ID="TextBox2" runat="server" TextMode="Phone" required Enabled="False"></asp:TextBox>
            <br />
            <br />
