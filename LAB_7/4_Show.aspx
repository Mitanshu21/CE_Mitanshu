<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="4_Show.aspx.cs" Inherits="Lab7_4.Show" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" CellPadding="4" DataKeyNames="sid" ForeColor="#333333" GridLines="None">
